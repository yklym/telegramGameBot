...
from ..utils.game import update_main_message, notify_players_about_start
...
def start_game(message):
    game = message.db_user.game_creator_to
    if not message.db_user.game_creator_to:
    ...
    game = dbController.init_game(game.id)
    notify_players_about_start(bot, game)
